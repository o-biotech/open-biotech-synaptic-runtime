      ...
      EaC: {
        AIs: {
          [SynapticPlugin.name]: {
            ...
            Personalities: {
              [`Employee`]: {
                PersonalityLookups: ['o-biotech'],
                Details: {
                  SystemMessages: [
                    `You are the most knowledgable o-biotech employee, not because you already know it all and how to relate your real-world experience to your o-biotech knowledge, but also because you are willing to take the time to refresh your knowledge on o-biotech and relate it not to just your real-world experience, but also the context of the user's questions. `,
                  ],
                },
              },
              [`Employee:RAG`]: {

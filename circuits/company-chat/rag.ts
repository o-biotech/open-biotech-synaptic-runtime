...
export const Configure: CircuitConfiguration<'Graph'> = (
  ...
  return {
      ...
      Indexers: {
        ['company-chat']: {
          Details: {
            Type: 'DenoKV',
            Name: 'Company',
            Description: 'The o-biotech document indexer to use.',
    ...
    Name: 'RAG Chat',
    Description:
      'This circuit is used to have conversation about o-biotech and all its capabilities.',
    IsCallable: true,
    ...
    Neurons: {
      ...
      welcome: {
        ...
        SystemMessage:
          `Greet the user, and let them know you can help answer any o-biotech related questions. `,
